...
Toy.create!(name: "Mr. Potato Head", pieces: 13, age_group_id: 1)
Toy.create!(name: "Flexi-Loop", pieces: 1, age_group_id: 1)
Toy.create!(name: "Links", pieces: 4, age_group_id: 1)
Toy.create!(name: "Learning with Animals Book", pieces: 1, age_group_id: 1)
Toy.create!(name: "Duck", pieces: 1, age_group_id: 1)
